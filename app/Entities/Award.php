...
{
    protected $fillable = ['name', 'state', 'award_type_id', 'user_id', 'organization_id', 'propietor_id', 'production_id', 'categories', 'sound', 'isSelected', 'isPreselected', 'isSelEdit', 'region_id', 'acceptTerms'];
